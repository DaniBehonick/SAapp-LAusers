...
New users, MX
```{r, New users MX}
LAnewusers_Dec20Jan22full_MX <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "MX")

newusers_MX_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_MX)
...
New users, AR
```{r, New users AR}
LAnewusers_Dec20Jan22full_AR <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "AR")

newusers_AR_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_AR)
...
New users, CO
```{r, New users CO}
LAnewusers_Dec20Jan22full_CO <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "CO")

newusers_CO_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_CO)
...
New users, GT
```{r, New users GT}
LAnewusers_Dec20Jan22full_GT <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "GT")

newusers_GT_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_GT)
...
New users, HN
```{r, New users HN}
LAnewusers_Dec20Jan22full_HN <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "HN")

newusers_HN_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_HN)
...
New users, PE
```{r, New users PE}
LAnewusers_Dec20Jan22full_PE <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "PE")

newusers_PE_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_PE)
...
New users, EC
```{r, New users EC}
LAnewusers_Dec20Jan22full_EC <- LAnewusers_Dec20Jan22full %>% filter(CountryID == "EC")

newusers_EC_lm <- lm(New_Users~Year_Month, LAnewusers_Dec20Jan22full_EC)
...
LAreturningusers_Dec20Jan22full_MX <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "MX")

returningusers_MX_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_MX)
...
LAreturningusers_Dec20Jan22full_AR <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "AR")

returningusers_AR_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_AR)
...
LAreturningusers_Dec20Jan22full_CO <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "CO")

returningusers_CO_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_CO)
...
LAreturningusers_Dec20Jan22full_GT <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "GT")

returningusers_GT_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_GT)
...
LAreturningusers_Dec20Jan22full_HN <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "HN")

returningusers_HN_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_HN)
...
LAreturningusers_Dec20Jan22full_PE <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "PE")

returningusers_PE_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_PE)
...
LAreturningusers_Dec20Jan22full_EC <- LAreturningusers_Dec20Jan22full %>% filter(CountryID == "EC")

returningusers_EC_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Dec20Jan22full_EC)
...
```{r}
LAnewusers_Aug21Jan22 <- LAnewusers_Dec20Jan22full %>% filter(Year_Month == "Aug 2021" | Year_Month == "Sep 2021" | Year_Month == "Oct 2021" | Year_Month == "Nov 2021" | Year_Month == "Dec 2021" | Year_Month == "Jan 2022")

LAreturningusers_Aug21Jan22 <- LAreturningusers_Dec20Jan22full %>% filter(Year_Month == "Aug 2021" | Year_Month == "Sep 2021" | Year_Month == "Oct 2021" | Year_Month == "Nov 2021" | Year_Month == "Dec 2021" | Year_Month == "Jan 2022")
...
New users, AR
```{r, New users Aug21-Jan22 AR}
LAnewusers_Aug21Jan22_AR <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "AR")
newusersAugJan_AR_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_AR)
New_usersAugJan_prediction_col_AR <- predict(newusersAugJan_AR_lm, New_dates)
New_users_predictionAugJan_AR <- cbind(New_dates, New_usersAugJan_prediction_col_AR)
```

New users, CO
```{r, New users Aug21-Jan22 CO}
LAnewusers_Aug21Jan22_CO <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "CO")
newusersAugJan_CO_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_CO)
New_usersAugJan_prediction_col_CO <- predict(newusersAugJan_CO_lm, New_dates)
New_users_predictionAugJan_CO <- cbind(New_dates, New_usersAugJan_prediction_col_CO)
```

New users, GT
```{r, New users Aug21-Jan22 GT}
LAnewusers_Aug21Jan22_GT <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "GT")
newusersAugJan_GT_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_GT)
New_usersAugJan_prediction_col_GT <- predict(newusersAugJan_GT_lm, New_dates)
New_users_predictionAugJan_GT <- cbind(New_dates, New_usersAugJan_prediction_col_GT)
```

New users, HN
```{r, New users Aug21-Jan22 HN}
LAnewusers_Aug21Jan22_HN <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "HN")
newusersAugJan_HN_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_HN)
New_usersAugJan_prediction_col_HN <- predict(newusersAugJan_HN_lm, New_dates)
New_users_predictionAugJan_HN <- cbind(New_dates, New_usersAugJan_prediction_col_HN)
```

New users, PE
```{r, New users Aug21-Jan22 PE}
LAnewusers_Aug21Jan22_PE <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "PE")
newusersAugJan_PE_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_PE)
New_usersAugJan_prediction_col_PE <- predict(newusersAugJan_PE_lm, New_dates)
New_users_predictionAugJan_PE <- cbind(New_dates, New_usersAugJan_prediction_col_PE)
```

New users, EC
```{r, New users Aug21-Jan22 EC}
LAnewusers_Aug21Jan22_EC <- LAnewusers_Aug21Jan22 %>% filter(CountryID == "EC")
newusersAugJan_EC_lm <- lm(New_Users~Year_Month, LAnewusers_Aug21Jan22_EC)
New_usersAugJan_prediction_col_EC <- predict(newusersAugJan_EC_lm, New_dates)
New_users_predictionAugJan_EC <- cbind(New_dates, New_usersAugJan_prediction_col_EC)
```

```{r}
New_users_predictionAugJan <- cbind(New_dates, New_users_predictionAugJan_AR$New_usersAugJan_prediction_col_AR, New_users_predictionAugJan_CO$New_usersAugJan_prediction_col_CO, New_users_predictionAugJan_EC$New_usersAugJan_prediction_col_EC, New_users_predictionAugJan_GT$New_usersAugJan_prediction_col_GT, New_users_predictionAugJan_HN$New_usersAugJan_prediction_col_HN, New_users_predictionAugJan_MX$New_usersAugJan_prediction_col_MX, New_users_predictionAugJan_PE$New_usersAugJan_prediction_col_PE)
colnames(New_users_predictionAugJan) <- c("Time", "New users prediction AR", "New users prediction CO", "New users prediction EC", "New users prediction GT", "New users prediction HN", "New users prediction MX", "New users prediction PE")
write.csv(New_users_predictionAugJan, "New_users_predictionLAAugJan.csv")
```

Returning users, MX
```{r, Returning users Aug21-Jan22 MX}
LAreturningusers_Aug21Jan22_MX <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "MX")
returningusersAugJan_MX_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_MX)
Returning_usersAugJan_prediction_col_MX <- predict(returningusersAugJan_MX_lm, New_dates)
Returning_users_predictionAugJan_MX <- cbind(New_dates, Returning_usersAugJan_prediction_col_MX)
```

Returning users, AR
```{r, Returning users Aug21-Jan22 AR}
LAreturningusers_Aug21Jan22_AR <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "AR")
returningusersAugJan_AR_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_AR)
Returning_usersAugJan_prediction_col_AR <- predict(returningusersAugJan_AR_lm, New_dates)
Returning_users_predictionAugJan_AR <- cbind(New_dates, Returning_usersAugJan_prediction_col_AR)
```

Returning users, CO
```{r, Returning users Aug21-Jan22 CO}
LAreturningusers_Aug21Jan22_CO <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "CO")
returningusersAugJan_CO_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_CO)
Returning_usersAugJan_prediction_col_CO <- predict(returningusersAugJan_CO_lm, New_dates)
Returning_users_predictionAugJan_CO <- cbind(New_dates, Returning_usersAugJan_prediction_col_CO)
```

Returning users, GT
```{r, Returning users Aug21-Jan22 GT}
LAreturningusers_Aug21Jan22_GT <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "GT")
returningusersAugJan_GT_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_GT)
Returning_usersAugJan_prediction_col_GT <- predict(returningusersAugJan_GT_lm, New_dates)
Returning_users_predictionAugJan_GT <- cbind(New_dates, Returning_usersAugJan_prediction_col_GT)
```

Returning users, HN
```{r, Returning users Aug21-Jan22 HN}
LAreturningusers_Aug21Jan22_HN <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "HN")
returningusersAugJan_HN_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_HN)
Returning_usersAugJan_prediction_col_HN <- predict(returningusersAugJan_HN_lm, New_dates)
Returning_users_predictionAugJan_HN <- cbind(New_dates, Returning_usersAugJan_prediction_col_HN)
```

Returning users, PE
```{r, Returning users Aug21-Jan22 PE}
LAreturningusers_Aug21Jan22_PE <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "PE")
returningusersAugJan_PE_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_PE)
Returning_usersAugJan_prediction_col_PE <- predict(returningusersAugJan_PE_lm, New_dates)
Returning_users_predictionAugJan_PE <- cbind(New_dates, Returning_usersAugJan_prediction_col_PE)
```

Returning users, EC
```{r, Returning users Aug21-Jan22 EC}
LAreturningusers_Aug21Jan22_EC <- LAreturningusers_Aug21Jan22 %>% filter(CountryID == "EC")
returningusersAugJan_EC_lm <- lm(Returning_Users~Year_Month, LAreturningusers_Aug21Jan22_EC)
Returning_usersAugJan_prediction_col_EC <- predict(returningusersAugJan_EC_lm, New_dates)
Returning_users_predictionAugJan_EC <- cbind(New_dates, Returning_usersAugJan_prediction_col_EC)
```

```{r}
Returning_users_predictionAugJan <- cbind(New_dates, Returning_users_predictionAugJan_AR$Returning_usersAugJan_prediction_col_AR, Returning_users_predictionAugJan_CO$Returning_usersAugJan_prediction_col_CO, Returning_users_predictionAugJan_EC$Returning_usersAugJan_prediction_col_EC, Returning_users_predictionAugJan_GT$Returning_usersAugJan_prediction_col_GT, Returning_users_predictionAugJan_HN$Returning_usersAugJan_prediction_col_HN, Returning_users_predictionAugJan_MX$Returning_usersAugJan_prediction_col_MX, Returning_users_predictionAugJan_PE$Returning_usersAugJan_prediction_col_PE)
colnames(Returning_users_predictionAugJan) <- c("Time", "Returning users prediction AR", "Returning users prediction CO", "Returning users prediction EC", "Returning users prediction GT", "Returning users prediction HN", "Returning users prediction MX", "Returning users prediction PE")
write.csv(Returning_users_predictionAugJan, "Returning_users_predictionLAAugJan.csv")
```