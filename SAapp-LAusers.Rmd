...
#pivot to make CountryID a callable variable
LAtotalusers_Dec20Jan22_3 <- pivot_longer(LAtotalusers_Dec20Jan22_2, cols=2:8, names_to = "Country", values_to = "New_users")

#rename columns
colnames(LAtotalusers_Dec20Jan22_3) <- c("Year_Month","CountryID","New_Users")
...
#coerce New_Users to numeric variable rather than character
LAtotalusers_Dec20Jan22_3$New_Users <- as.numeric(LAtotalusers_Dec20Jan22_3$New_Users)
typeof(LAtotalusers_Dec20Jan22_3$New_Users)
...
=======
>>>>>>> 85d1bf093096b2bdad2db23321e80d84732b1289
ggplot(data = LAtotalusers_Dec20Jan22_3, aes(x=Year_Month, y=New_Users)) + 
  geom_line(aes(color=CountryID)) + labs(x = "Year_Month", y = "New Users", 
